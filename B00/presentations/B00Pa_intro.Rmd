...
1.  La machine n'est plus créée dans le compte gratuit, limité à 2h/mois. Prévenez-nous pour des tâches lourdes dans la SciViews Box 2024 pour d'autres cours.

2.  Un login et mot de passe sont nécessaires pour accéder aux apps Shiny et au rapport de progression.

### Étapes de l'installation

0.  Accéder au cours sur Moodle **Science des données II : modélisation** (mdp : sdd2umons) et se connecter à son compte GitHub <https://github.com/>.
1.  Aller sur le site du cours : <https://wp.sciviews.org/>
2.  Lier le cours et se connecter avec son compte GitHub.

Cliquez sur le bouton bleu **RStudio** en haut à droite pour les instructions d'installation (nous le ferons ensemble).
