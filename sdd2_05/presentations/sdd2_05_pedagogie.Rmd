...
- **Corriger et ne plus commettre** toutes ces erreurs.

- La **réalisation technique** d'un graphique ou d'une analyse ne sera plus suffisante (taxonomie de Bloom\ : **appliquer**). Vous allez maintenant vous focaliser sur votre capacité à **analyser** vos résultats.
