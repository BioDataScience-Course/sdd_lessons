...
### Erreurs récurrentes : Les interprétations simplistes

L'interprétation d'un graphique est importante. Elle met en avant votre compréhension de la situation. Une bonne interprétation est généralement liée à un graphique de qualité. 
...
- On ne réalise plus toutes les erreurs citées précédemment.

- La **réalisation technique** d'un graphique ou d'une analyse ne sera plus suffisante (Taxonomie de Bloom révisée: Appliquer) => Vous devez à présent être capable d' **analyser** vos résultats.
