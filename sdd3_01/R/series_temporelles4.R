...
# Ne fonctionne pas tant qu'il y a une tendance
# => stationnariser d'abord (faites-le comme exercice!)
...
plot(co2.loess.ts[, 3])
acf(co2.loess.ts[, 3]) # Typique d'une tendance très forte
spectrum(co2.loess.ts[, 3], span = c(3, 7))
