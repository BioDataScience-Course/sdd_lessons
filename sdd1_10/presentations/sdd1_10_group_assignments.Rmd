...
subtitle:  \includegraphics[width=.08\textwidth,height=.1\textheight]{../../template/biodatascience.png}
  \includegraphics[width=.08\textwidth,height=.1\textheight]{../../template/SciViews-logo.pdf} \vfill Travaux de groupes
...
Lors de cours de *Science des données I: inférence*, vous avez actuellement 2 travaux de groupes à réaliser :
...
Il s'agit du projet principal de cours de *Science des données I: inférence*. Ce travail par 4 est décomposé en plusieurs phases afin de vous aider à vous organiser.
...
- biometry.R : Préparer d'un tableau de données avec les labels et les unités associés à chaque variable.
